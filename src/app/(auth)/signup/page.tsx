        ...
        <div className="h-screen w-screen flex items-center justify-center">
            <div className="relative flex flex-col gap-10 justify-center items-center pt-12 p-10 border border-black/20 rounded-md shadow-md shadow-black/20">
                ...
                <div className="flex gap-2">
                    <p className="text-zinc-500">Vous possedez déjà un compte ?</p>
                    <Link className="relative after:content-[''] after:absolute after:bottom-[-2px] after:left-0 after:w-[0px] hover:after:w-full after:transition-width after:duration-300 after:h-[1px] after:bg-zinc-950" href="/signin">
                        Connectez-vous
                    </Link>
                </div>
            </div>
